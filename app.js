...
function go(id,kind){$$(".page").forEach(x=>x.classList.remove("active"));$("#"+id).classList.add("active");$$("nav button").forEach(b=>b.classList.toggle("nav-active",b.dataset.go===id));if(id==="compress"&&kind)setup(kind);if(id==="files")renderFiles();if(id==="settings")loadSettings();if(id==="home")refreshHome();scrollTo(0,0)}
